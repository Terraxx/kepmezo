<?php /* Smarty version 2.6.11, created on 2015-08-27 00:50:37
         compiled from cache/modules/Contacts/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/modules/Contacts/EditView.tpl', 43, false),array('modifier', 'default', 'cache/modules/Contacts/EditView.tpl', 54, false),array('modifier', 'strip_semicolon', 'cache/modules/Contacts/EditView.tpl', 72, false),array('modifier', 'lookup', 'cache/modules/Contacts/EditView.tpl', 569, false),array('modifier', 'count', 'cache/modules/Contacts/EditView.tpl', 649, false),array('function', 'sugar_include', 'cache/modules/Contacts/EditView.tpl', 49, false),array('function', 'counter', 'cache/modules/Contacts/EditView.tpl', 55, false),array('function', 'sugar_getimagepath', 'cache/modules/Contacts/EditView.tpl', 58, false),array('function', 'sugar_translate', 'cache/modules/Contacts/EditView.tpl', 61, false),array('function', 'html_options', 'cache/modules/Contacts/EditView.tpl', 78, false),array('function', 'sugar_getjspath', 'cache/modules/Contacts/EditView.tpl', 279, false),)), $this); ?>
...
<input type="hidden" id="old_<?php echo $this->_tpl_vars['fields']['contact_photo_c']['name']; ?>
" name="old_<?php echo $this->_tpl_vars['fields']['contact_photo_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['fields']['contact_photo_c']['name']]['value']; ?>
"/>
<input id="<?php echo $this->_tpl_vars['fields']['contact_photo_c']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['contact_photo_c']['name']; ?>
" type="file" title='' size="30" maxlength='255' value="<?php echo $this->_tpl_vars['fields'][$this->_tpl_vars['fields']['contact_photo_c']['name']]['value']; ?>
" >
<?php if (! empty ( $this->_tpl_vars['fields']['contact_photo_c']['value'] )): ?>
<img src='cache/images/thumb/<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
_<?php echo $this->_tpl_vars['fields']['contact_photo_c']['value']; ?>
...
addToValidate(\'EditView\', \'contact_photo_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_PHOTO','module' => 'Contacts','for_js' => true), $this); echo '\' );
