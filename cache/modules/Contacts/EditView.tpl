...
{capture name="tr" assign="tableRow"}
<tr>
<td valign="top" id='contact_photo_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_CONTACT_PHOTO' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<td valign="top" width='37.5%' colspan='3'>
{counter name="panelFieldCount"}
<input type="hidden" id="old_{$fields.contact_photo_c.name}" name="old_{$fields.contact_photo_c.name}" value="{$fields[$fields.contact_photo_c.name].value}"/>
<input id="{$fields.contact_photo_c.name}" name="{$fields.contact_photo_c.name}" type="file" title='' size="30" maxlength='255' value="{$fields[$fields.contact_photo_c.name].value}" >
{if !empty($fields.contact_photo_c.value)}
<img src='cache/images/thumb/{$fields.id.value}_{$fields.contact_photo_c.value}' style="max-height: 150px;">
{/if}
</tr>
{/capture}
{if $fieldsUsed > 0 }
...
<label for="primary_address_street">{sugar_translate label='LBL_PRIMARY_ADDRESS_STREET' module=''}:</label>
</td>
<td>
...
<label for="primary_address_city">{sugar_translate label='LBL_PRIMARY_ADDRESS_CITY' module=''}:</label>
</td>
<td>
<input type="text" name="primary_address_city" id="primary_address_city" size="30" maxlength="100" value='{$fields.primary_address_city.value}' tabindex="0">
</td>
</tr>
<tr>
<td id="primary_address_state_label" width='%' scope='row' >
<label for="primary_address_state">{sugar_translate label='LBL_PRIMARY_ADDRESS_STATE' module=''}:</label>
</td>
<td>
<input type="text" name="primary_address_state" id="primary_address_state" size="30" maxlength="100" value='{$fields.primary_address_state.value}' tabindex="0">
</td>
</tr>
<tr>
<td id="primary_address_postalcode_label" width='%' scope='row' >
<label for="primary_address_postalcode">{sugar_translate label='LBL_PRIMARY_ADDRESS_POSTALCODE' module=''}:</label>
</td>
<td>
<input type="text" name="primary_address_postalcode" id="primary_address_postalcode" size="30" maxlength="20" value='{$fields.primary_address_postalcode.value}' tabindex="0">
</td>
</tr>
<tr>
<td id="primary_address_country_label" width='%' scope='row' >
<label for="primary_address_country">{sugar_translate label='LBL_PRIMARY_ADDRESS_COUNTRY' module=''}:</label>
</td>
<td>
...
<label for="alt_address_street">{sugar_translate label='LBL_ALT_ADDRESS_STREET' module=''}:</label>
</td>
<td>
...
<label for="alt_address_city">{sugar_translate label='LBL_ALT_ADDRESS_CITY' module=''}:</label>
</td>
<td>
<input type="text" name="alt_address_city" id="alt_address_city" size="30" maxlength="100" value='{$fields.alt_address_city.value}' tabindex="0">
</td>
</tr>
<tr>
<td id="alt_address_state_label" width='%' scope='row' >
<label for="alt_address_state">{sugar_translate label='LBL_ALT_ADDRESS_STATE' module=''}:</label>
</td>
<td>
<input type="text" name="alt_address_state" id="alt_address_state" size="30" maxlength="100" value='{$fields.alt_address_state.value}' tabindex="0">
</td>
</tr>
<tr>
<td id="alt_address_postalcode_label" width='%' scope='row' >
<label for="alt_address_postalcode">{sugar_translate label='LBL_ALT_ADDRESS_POSTALCODE' module=''}:</label>
</td>
<td>
<input type="text" name="alt_address_postalcode" id="alt_address_postalcode" size="30" maxlength="20" value='{$fields.alt_address_postalcode.value}' tabindex="0">
</td>
</tr>
<tr>
<td id="alt_address_country_label" width='%' scope='row' >
<label for="alt_address_country">{sugar_translate label='LBL_ALT_ADDRESS_COUNTRY' module=''}:</label>
</td>
<td>
...
addToValidate('EditView', 'contact_photo_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CONTACT_PHOTO' module='Contacts' for_js=true}{literal}' );
